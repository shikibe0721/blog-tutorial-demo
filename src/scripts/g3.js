// G4 连续圆角引擎（全浏览器兼容）
(function () {
  var SEL = '.home-card, .about-card, .about-big, .about-small, .admin-container, #post-form, .calendar, .user-card, .comments-card, .post-item, .ios-btn, .ios-btn-secondary, .ios-btn-danger, .tab, .date-btn, .like-btn, .react-btn, .comment-submit, .tag-chip, .sort-btn, .admin-link, .back-btn, .tl-item, input, textarea, .gb-editor, .gb-send, .gb-login-hint';
  var N = 5;
  var STEPS = 14;
